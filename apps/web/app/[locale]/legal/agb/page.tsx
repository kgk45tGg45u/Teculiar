      ...
      <section className={styles.content}>
        <div className="container">
          <div className={styles.prose}>
            ...
            <p>
              {isDe
                ? "Rechnungen werden automatisch vom System erstellt und per E-Mail verschickt. Unbezahlte Rechnungen sind mit UNPAID, bezahlte mit PAID gekennzeichnet. Kunden können alle Rechnungen als PDF-Dokumente im Mein-Dezhost-Portal abrufen. PAID-Rechnungen können zu steuerlichen Zwecken verwendet werden."
                : "Invoices are automatically generated by the system and sent by email. Unpaid invoices are marked UNPAID, paid ones PAID. Customers can access all invoices as PDF documents in the My Dezhost portal. PAID invoices can be used for tax purposes."}
            </p>
