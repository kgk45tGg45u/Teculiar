    ...
    ? [
        {
          ...
          features: ["E-Mail-Support", "Reaktionszeit 48h", "Sicherheitsupdates", "Monatlicher Status-Check"]
        },
        {
          name: "Standard-Support",
          price: "ab 59 €/Monat",
          desc: "Für aktive Websites und Organisationen.",
          features: ["E-Mail & Telefon-Support", "Reaktionszeit 24h", "Sicherheitsupdates", "WordPress-Wartung", "Monatlicher Bericht"],
          featured: true
        },
        {
          ...
          features: ["Persönlicher Ansprechpartner", "Reaktionszeit 4h", "Alle Updates & Wartung", "Monitoring & Alerts", "Quartalsweise Beratung"]
        }
      ]
    : [
        {
          ...
          features: ["Email support", "Response time 48h", "Security updates", "Monthly status check"]
        },
        {
          name: "Standard Support",
          price: "from €59/month",
          desc: "For active websites and organisations.",
          features: ["Email & phone support", "Response time 24h", "Security updates", "WordPress maintenance", "Monthly report"],
          featured: true
        },
        {
          name: "Managed Services",
          ...
          features: ["Personal contact person", "Response time 4h", "All updates & maintenance", "Monitoring & alerts", "Quarterly consultation"]
        }
      ];
    ...
    <>
      <section className={styles.hero}>
        <div className="container">
          <span className="eyebrow">{isDe ? "Preisliste" : "Pricing"}</span>
          <h1>{isDe ? "Faire Preise. Keine Überraschungen." : "Fair prices. No surprises."}</h1>
          <p>
            {isDe
              ? "Transparente Preise für Hosting, Domains und IT-Dienstleistungen. Keine versteckten Kosten, keine automatischen Verlängerungen ohne Ankündigung."
              : "Transparent prices for hosting, domains and IT services. No hidden costs, no automatic renewals without notice."}
          </p>
        </div>
      </section>
          ...
          <div className={styles.supportGrid}>
            {supportPackages.map((pkg) => (
              <div className={`${styles.supportCard} ${pkg.featured ? styles.featuredCard : ""}`} key={pkg.name}>
                ...
                <Button href={`/${locale}/contact`} icon={ArrowRight} variant={pkg.featured ? "primary" : "secondary"}>
      ...
      <section className={`section tight ${styles.hourlySection}`}>
        <div className="container">
