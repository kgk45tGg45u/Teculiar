...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return pageMetadata("legal-impressum", locale);
}
...
export default async function ImpressumPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <CustomPageGate locale={locale} pageKey="legal-impressum">
      <ImpressumPageBuiltIn locale={locale} />
    </CustomPageGate>
  );
}

async function ImpressumPageBuiltIn({ locale }: { locale: Locale }) {
